...
public class RpcResourceCategoryQuery implements org.apache.thrift.TBase<RpcResourceCategoryQuery, RpcResourceCategoryQuery._Fields>, java.io.Serializable, Cloneable, Comparable<RpcResourceCategoryQuery> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RpcResourceCategoryQuery");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RpcResourceCategoryQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RpcResourceCategoryQueryTupleSchemeFactory();
  ...
  private java.util.List<RpcResourceCategory> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RpcResourceCategoryQuery.class, metaDataMap);
  }

  public RpcResourceCategoryQuery() {
    this.pageSize = 15;
  ...
  public RpcResourceCategoryQuery(
    ...
    int minPage,
    int firstResult,
    java.util.List<RpcResourceCategory> resultList)
  {
    this();
   ...
   */
  public RpcResourceCategoryQuery(RpcResourceCategoryQuery other) {
    ...
    if (other.isSetResultList()) {
      java.util.List<RpcResourceCategory> __this__resultList = new java.util.ArrayList<RpcResourceCategory>(other.resultList.size());
      for (RpcResourceCategory other_element : other.resultList) {
        __this__resultList.add(new RpcResourceCategory(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public RpcResourceCategoryQuery deepCopy() {
    return new RpcResourceCategoryQuery(this);
  }
  ...
  public java.util.Iterator<RpcResourceCategory> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(RpcResourceCategory elem) {
    if (this.resultList == null) {
      this.resultList = new java.util.ArrayList<RpcResourceCategory>();
    }
    this.resultList.add(elem);
  }

  public java.util.List<RpcResourceCategory> getResultList() {
    return this.resultList;
  }

  public void setResultList(java.util.List<RpcResourceCategory> resultList) {
    this.resultList = resultList;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((java.util.List<RpcResourceCategory>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof RpcResourceCategoryQuery)
      return this.equals((RpcResourceCategoryQuery)that);
    return false;
  }

  public boolean equals(RpcResourceCategoryQuery that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RpcResourceCategoryQuery other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RpcResourceCategoryQuery(");
    boolean first = true;
  ...
  private static class RpcResourceCategoryQueryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcResourceCategoryQueryStandardScheme getScheme() {
      return new RpcResourceCategoryQueryStandardScheme();
    }
  }

  private static class RpcResourceCategoryQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<RpcResourceCategoryQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RpcResourceCategoryQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new java.util.ArrayList<RpcResourceCategory>(_list8.size);
                RpcResourceCategory _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new RpcResourceCategory();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RpcResourceCategoryQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (RpcResourceCategory _iter11 : struct.resultList)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class RpcResourceCategoryQueryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcResourceCategoryQueryTupleScheme getScheme() {
      return new RpcResourceCategoryQueryTupleScheme();
    }
  }

  private static class RpcResourceCategoryQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<RpcResourceCategoryQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RpcResourceCategoryQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (RpcResourceCategory _iter12 : struct.resultList)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RpcResourceCategoryQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resultList = new java.util.ArrayList<RpcResourceCategory>(_list13.size);
          RpcResourceCategory _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new RpcResourceCategory();
            _elem14.read(iprot);
