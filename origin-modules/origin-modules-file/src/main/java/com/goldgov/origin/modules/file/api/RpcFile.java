...
public class RpcFile implements org.apache.thrift.TBase<RpcFile, RpcFile._Fields>, java.io.Serializable, Cloneable, Comparable<RpcFile> {
  ...
  private java.lang.String fileID; // optional
  private java.lang.String fileName; // optional
  private long fileSize; // optional
  private java.lang.String fileType; // optional
  private long createDate; // optional
  private java.lang.String groupID; // optional
  private long downloadNum; // optional
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDownloadNum()) ? 131071 : 524287);
    if (isSetDownloadNum())
