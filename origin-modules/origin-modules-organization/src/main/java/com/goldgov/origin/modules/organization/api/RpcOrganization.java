...
public class RpcOrganization implements org.apache.thrift.TBase<RpcOrganization, RpcOrganization._Fields>, java.io.Serializable, Cloneable, Comparable<RpcOrganization> {
  ...
  private RpcOrganization parentOrganization; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PARENT_ORGANIZATION, new org.apache.thrift.meta_data.FieldMetaData("parentOrganization", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public RpcOrganization(
    ...
    int nodeValue,
    RpcOrganization parentOrganization)
  {
    this();
    this.orgID = orgID;
