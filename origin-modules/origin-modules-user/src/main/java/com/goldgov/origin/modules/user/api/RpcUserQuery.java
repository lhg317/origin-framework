...
public class RpcUserQuery implements org.apache.thrift.TBase<RpcUserQuery, RpcUserQuery._Fields>, java.io.Serializable, Cloneable, Comparable<RpcUserQuery> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RpcUserQuery");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RpcUserQueryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RpcUserQueryTupleSchemeFactory();
  ...
  private java.util.List<RpcUser> resultList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RpcUserQuery.class, metaDataMap);
  }
  ...
  public RpcUserQuery(
    ...
    int minPage,
    int firstResult,
    java.util.List<RpcUser> resultList)
  {
    this();
   ...
   */
  public RpcUserQuery(RpcUserQuery other) {
    ...
    if (other.isSetResultList()) {
      java.util.List<RpcUser> __this__resultList = new java.util.ArrayList<RpcUser>(other.resultList.size());
      for (RpcUser other_element : other.resultList) {
        __this__resultList.add(new RpcUser(other_element));
      }
      this.resultList = __this__resultList;
    }
  }

  public RpcUserQuery deepCopy() {
    return new RpcUserQuery(this);
  }
  ...
  public java.util.Iterator<RpcUser> getResultListIterator() {
    return (this.resultList == null) ? null : this.resultList.iterator();
  }

  public void addToResultList(RpcUser elem) {
    if (this.resultList == null) {
      this.resultList = new java.util.ArrayList<RpcUser>();
    }
    this.resultList.add(elem);
  }

  public java.util.List<RpcUser> getResultList() {
    return this.resultList;
  }

  public void setResultList(java.util.List<RpcUser> resultList) {
    this.resultList = resultList;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RESULT_LIST:
      if (value == null) {
        ...
        setResultList((java.util.List<RpcUser>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof RpcUserQuery)
      return this.equals((RpcUserQuery)that);
    return false;
  }

  public boolean equals(RpcUserQuery that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RpcUserQuery other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RpcUserQuery(");
    boolean first = true;
  ...
  private static class RpcUserQueryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcUserQueryStandardScheme getScheme() {
      return new RpcUserQueryStandardScheme();
    }
  }

  private static class RpcUserQueryStandardScheme extends org.apache.thrift.scheme.StandardScheme<RpcUserQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RpcUserQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultList = new java.util.ArrayList<RpcUser>(_list0.size);
                RpcUser _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RpcUserQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.resultList != null) {
        oprot.writeFieldBegin(RESULT_LIST_FIELD_DESC);
        {
          ...
          for (RpcUser _iter3 : struct.resultList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class RpcUserQueryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RpcUserQueryTupleScheme getScheme() {
      return new RpcUserQueryTupleScheme();
    }
  }

  private static class RpcUserQueryTupleScheme extends org.apache.thrift.scheme.TupleScheme<RpcUserQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RpcUserQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResultList()) {
        {
          ...
          for (RpcUser _iter4 : struct.resultList)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RpcUserQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.resultList = new java.util.ArrayList<RpcUser>(_list5.size);
          RpcUser _elem6;
